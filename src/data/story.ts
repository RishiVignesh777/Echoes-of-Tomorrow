...
export const STORY_LOGS: Record<string, StoryLog> = {
  ...
  log_6_1: {
    ...
    category: 'Classified',
    sectorName: 'Sector 06: Omega Reactor',
    content: [
  ...
  log_7_1: {
    id: 'log_7_1',
    title: 'LOST WING ARCHIVE - QUANTUM DISPLACEMENT PODS',
    author: 'Dr. Aris Thorne & V. Ramos',
    date: '2090-04-12 // 11:30 EST',
    category: 'Research',
    sectorName: 'Sector 07: The Lost Wing',
    content: [
      'The Lost Wing was sealed after the first containment breach in Sub-Level 4.',
      'Here, we prototyped the Echo Transfer Machine. By channeling a high-frequency chroniton pulse through dual pods, an Echo recorded in Chamber Alpha can be spatially shifted into Chamber Beta.',
      'The limitation: transfer only functions while an Echo is currently active within the pod grid.',
      'Use this mechanism to trigger switches isolated behind reinforced blast glass.',
    ],
  },
  log_8_1: {
    id: 'log_8_1',
    title: 'PARADOX PROTOCOL - ARTIFICIAL DECOY BEACONS',
    author: 'Chief of Facility Defense J. Vance',
    date: '2090-08-18 // 14:02 EST',
    category: 'Security',
    sectorName: 'Sector 08: Paradox Protocol',
    content: [
      'The Paradox anomaly is aggressive and lethal, but it operates on raw chroniton sensory input.',
      'We installed tactical Temporal Decoy consoles throughout the patrol labyrinth.',
      'Activating a decoy emits a sharp burst of artificial temporal noise. The Paradox will immediately break patrol to investigate the source.',
      'Be advised: Decoy units require 8 seconds to recharge between pulses. Time your movements carefully.',
    ],
  },
  log_9_1: {
    id: 'log_9_1',
    title: 'MEMORY VAULT MANIFEST - THE FORGOTTEN PERSONNEL',
    author: 'Archivist Unit 7',
    date: '2090-10-02 // 00:00 EST',
    category: 'Classified',
    sectorName: 'Sector 09: Memory Vault',
    content: [
      'All personal files of the 38 research scientists assigned to Project Tomorrow have been quarantined.',
      'As iterations multiply, cognitive retention deteriorates exponentially.',
      'Memory Fragments have crystallized as physical anomalies due to extreme chronological compression.',
      'Collecting these fragments restores fragmented synaptics to the subject.',
    ],
  },
  log_10_1: {
    id: 'log_10_1',
    title: 'OBSERVER SURVEILLANCE REPORT #99',
    author: 'Automated Diagnostic Subroutine',
    date: '2090-12-10 // 23:59 EST',
    category: 'Incident',
    sectorName: 'Sector 10: The Observer’s Sanctum',
    content: [
      'SURVEILLANCE CAMERAS 4A, 7B, and 12C report unexplainable visual shadows.',
      'A human silhouette matching Subject Thorne’s biological profile has been observed standing on unreachable observation gantries.',
      'Whenever local sensors approach within 5 meters, the entity dissolves into sub-atomic phase particles.',
      'Entity does not exhibit hostility. It appears to be monitoring the loop’s progression toward critical mass.',
    ],
  },
  log_11_1: {
    id: 'log_11_1',
    title: 'COLLAPSE NOTICE - MULTI-STATE INSTABILITY',
    author: 'Emergency Facility Broadcast',
    date: '2091-02-28 // CRITICAL',
    category: 'Incident',
    sectorName: 'Sector 11: Fractured Labs',
    content: [
      'WARNING: REALITY PHASE DRIFT AT MAXIMUM VOLATILITY.',
      'Sector 11 is fluctuating between three chronological states: State A (Intact Research Lab), State B (Hazard-Damaged Fissures), and State C (Derelict Abandoned Overgrowth).',
      'The Chrono-Phase Shifter console in the center allows direct manipulation of the active physical state.',
      'Obstacles impenetrable in State A may be fractured open in State B or completely decayed in State C.',
    ],
  },
  log_12_1: {
    id: 'log_12_1',
    title: 'VOID CORE - THE FINAL THRESHOLD',
    author: 'Dr. Aris Thorne (Final Iteration)',
    date: 'OUTSIDE TIMELINE',
    category: 'Classified',
    sectorName: 'Sector 12: The Void Collapse',
    content: [
      'This is the heart of the anomaly. The Void Core where all twelve hundred timelines converge.',
      'Every Echo you have ever created is waiting here.',
      'Coordinate with your past selves through the final phase-shifting puzzle matrix.',
      'When the central gate opens, step into the Singularity. Do not look back.',
    ],
    isClassified: true,
    revealsSecret: true,
  },
  // Aliases for update sectors
  log_lost_wing_1: {
    id: 'log_lost_wing_1',
    title: 'LOST WING ARCHIVE - QUANTUM DISPLACEMENT PODS',
    author: 'Dr. Aris Thorne & V. Ramos',
  ...
  log_observer_encounter: {
    id: 'log_observer_encounter',
    title: 'OBSERVER SURVEILLANCE REPORT #99',
    author: 'Automated Diagnostic Subroutine',
    date: '2090-12-10 // 23:59 EST',
    category: 'Incident',
    sectorName: 'Sector 10: Spectral Sanctuary',
    content: [
      'SURVEILLANCE CAMERAS 4A, 7B, and 12C report unexplainable visual shadows.',
      'A human silhouette matching Subject Thorne’s biological profile has been observed standing on unreachable observation gantries.',
      'Whenever local sensors approach within 5 meters, the entity dissolves into sub-atomic phase particles.',
  ...
  log_collapse_singularity: {
    id: 'log_collapse_singularity',
    title: 'COLLAPSE NOTICE - MULTI-STATE INSTABILITY',
    author: 'Emergency Facility Broadcast',
    date: '2091-02-28 // CRITICAL',
    category: 'Incident',
    sectorName: 'Sector 11: Quantum Decay',
    content: [
      'WARNING: REALITY PHASE DRIFT AT MAXIMUM VOLATILITY.',
      'Sector 11 is fluctuating between three chronological states: State A (Intact Research Lab), State B (Hazard-Damaged Fissures), and State C (Derelict Abandoned Overgrowth).',
      'The Chrono-Phase Shifter console in the center allows direct manipulation of the active physical state.',
  ...
  log_observer_manifesto: {
    id: 'log_observer_manifesto',
    title: 'THE FINAL PARADOX MANIFESTO',
    author: 'Dr. Aris Thorne (The Observer)',
    date: 'OUTSIDE TIMELINE',
    category: 'Classified',
    sectorName: 'Sector 12: The Omega Singularity',
    content: [
      'You have made it to the Omega Singularity.',
      'Every iteration, every failure, every recorded Echo has built the neural framework for this exact moment.',
      'Align the resonance frequencies, deploy the decoy diversion, and transfer your quantum essence into the core.',
      'Break the cage of Project Tomorrow.',
    ],
    isClassified: true,
    revealsSecret: true,
  },
